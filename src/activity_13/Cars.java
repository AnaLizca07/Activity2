...
public class Cars {
    public Integer typeOfCar;
    public Integer refsChev;
    public Integer refsMazda;
    public Integer refsRenault;
    public String chevroletSparkGT = "Modelo: Chevrolet Spark GT 2019\n" +
            ...
            "            -LT 2019: $36.900.000\n" +
            "            -LTZ 2019: $39.900.000";
    public String chevroletcaptiva = "alert(`Motor: 1.5 litros turbo\n" +
    ...
    public String mazda2 = "alert(`Marca\tMazda\n" +
            "            Modelo\t2\n" +
            "            Año\t2023\n" +
    ...
    public String mazda6 = "alert(`Marca\tMazda\n" +
            "            Modelo\t6\n" +
            "            Año\t2012\n" +
            "            Versión\tL5NA1 TP\n" +
            "            Color\tBlanco\n" +
            ...
            "            Puertas\t4\n" +
            "            Transmisión\tAutomática";
    public String renaultDusterOroch = "Marca\tRenault\n" +
            "            Modelo\tDuster Oroch\n" +
            "            Año\t2023\n" +
            "            Versión\tCargo 4x4\n" +
            "            Color\tGris\n" +
    ...
    public String renaultSandero = "Marca\tRenault\n" +
            "            Modelo\tSandero\n" +
            "            Año\t2017\n" +
